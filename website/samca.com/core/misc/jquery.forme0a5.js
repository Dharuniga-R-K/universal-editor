...
/* eslint-enable */
  ...
  $.fn.ajaxSubmit = function (options, data, dataType, onSuccess) {
    ...
    let method; let action; let url; let isMsie; let iframeSrc; const
      $form = this;
    ...
    if (options.data) {
      const optionsData = typeof (options.data) === 'function' ? options.data(a) : options.data;
    ...
    if (!options.dataType && options.target) {
      ...
      callbacks.push(function (data, textStatus, jqXHR) {
        const successArguments = arguments;
  ...
  $.fn.formToArray = function (semantic, elements, filtering) {
    ...
    let i; let j; let n; let v; let el; let max; let
      jmax;
