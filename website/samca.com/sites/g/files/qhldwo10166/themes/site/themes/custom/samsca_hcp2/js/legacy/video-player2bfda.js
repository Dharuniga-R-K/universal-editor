...
Sam.UI.vidPlayer = {
  ...
  init(video, videoStill) {
    ...
    const drupalVideoFilesPath = document.getElementById('video-files-path').getAttribute('data-video-path');
